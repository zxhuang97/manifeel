...
class DiffusionTransformerImagePolicy(BaseImagePolicy):
    """
    Same obs_encoder as DiffusionUnetImagePolicy (MultiImageObsEncoder),
    but uses TransformerForDiffusion as the denoising backbone instead of ConditionalUnet1D.
    """
    def __init__(self,
            shape_meta: dict,
    ...
    def predict_action(self, obs_dict: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        ...
        if self.obs_as_cond:
            ...
            # (B, To, Do) — transformer expects sequence conditioning
    ...
    def compute_loss(self, batch):
        ...
        if self.obs_as_cond:
            ...
            nobs_features = self.obs_encoder(this_nobs)
            # (B, To, Do) — keep as sequence for transformer

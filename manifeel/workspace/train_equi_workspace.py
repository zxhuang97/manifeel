...
from manifeel.policy.diffusion_equi_unet_cnn_enc_rel_policy import DiffusionEquiUNetCNNEncRelPolicy
...
class TrainEquiWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model: DiffusionEquiUNetCNNEncRelPolicy = hydra.utils.instantiate(cfg.policy)

        self.ema_model: DiffusionEquiUNetCNNEncRelPolicy = None
